          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1 relative">
              <textarea
                ...
                disabled={step !== "input"}
                style={{ fontSize: "16px" }}
                className={`w-full bg-card border rounded-xl px-4 py-2.5 text-foreground placeholder:text-muted-foreground outline-none focus:ring-1 focus:ring-primary disabled:opacity-50 resize-none min-h-[42px] ${isOverLimit ? "border-destructive" : "border-border"}`}
              />
